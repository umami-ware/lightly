...
class MappingsApi(object):
    ...
    def get_sample_mappings_by_dataset_id(
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.get_sample_mappings_by_dataset_id_with_http_info(
                dataset_id, field, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_sample_mappings_by_dataset_id_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `dataset_id` when calling `get_sample_mappings_by_dataset_id`"
            )  # noqa: E501
        # verify the required parameter 'field' is set
        if self.api_client.client_side_validation and (
            "field" not in params or params["field"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `field` when calling `get_sample_mappings_by_dataset_id`"
            )  # noqa: E501
