...
class JobsApi(object):
    ...
    def get_job_status_by_id(self, job_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_job_status_by_id_with_http_info(
                job_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_job_status_by_id_with_http_info(
                job_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_job_status_by_id_with_http_info(self, job_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `job_id` when calling `get_job_status_by_id`"
            )  # noqa: E501
