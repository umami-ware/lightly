...
class _UploadEmbeddingsMixin:
    ...
    def set_embedding_id_by_name(self, embedding_name: str = None):
        ...
        try:
            ...
            raise ValueError(
                f"No embedding with name {embedding_name} found on the server."
            )
    ...
    def upload_embeddings(self, path_to_embeddings_csv: str, name: str):
        ...
        names_embeddings_on_server = [
            embedding.name for embedding in embeddings_on_server
        ]
        ...
        response: WriteCSVUrlData = (
            self.embeddings_api.get_embeddings_csv_write_url_by_id(
        ...
        with tempfile.SpooledTemporaryFile(mode="r+b") as f_bytes:
            ...
            self.upload_file_with_signed_url(
                file=f_bytes, signed_write_url=signed_write_url
            )
    ...
    def append_embeddings(self, path_to_embeddings_csv: str, embedding_id: str):
        ...
        embedding_read_url = self.embeddings_api.get_embeddings_csv_read_url_by_id(
